...
import { iphone, samsung_s23, GooglePixel, oneplus11, iQOO11, Xiaomi12, OppoReno8, VivoX80, SonyXperia1, SonyXperia5, RedmiNote12, realmeGT2 } from "../../assets/index";
        ...
        <div className="App bg-gray-200 w-[99vw] h-[52vh]">
            <div className="relative">
                ...
                <div id="content" className="carousel p-4 flex items-center justify-start overflow-x-auto scroll-smooth  scrollbar-hide">
                    ...
                    <div>
                        <Card Product_Img={OppoReno8} title={"Oppo Reno8 5G (Shimmer Black, 128 GB) (8 GB RAM)"} category={" GB RAM | 128 GB ROM 16.33 cm (6.43 inch)"} org_price={29999} dup_price={38999}/>
                    </div>
                    <div>
                        <Card Product_Img={VivoX80} title={"Vivo X80 (Cosmic Black,8GB RAM, 128GB Storage)"} category={"17.22 cm (6.78 inch) Full HD+ Display"} org_price={46999} dup_price={59999}/>
                    </div>
                    <div>
                        <Card Product_Img={SonyXperia1} title={"Sony Xperia 1 III XQ-BC72 5G (Frosted Gray, 12GB RAM, 256GB Storage)"} category={"Color: Frosted Gray"} org_price={81999} dup_price={121999}/>
                    </div>
                    <div>
